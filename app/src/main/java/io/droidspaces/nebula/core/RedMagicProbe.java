...
public final class RedMagicProbe {
    ...
    private RedMagicProbe(boolean available, String deviceSummary, String fanSummary,
    ...
    public static RedMagicProbe unavailable(String reason) {
        return new RedMagicProbe(false, "unavailable", "unavailable",
    ...
    public static RedMagicProbe fromJson(String json) {
        try {
            ...
            return new RedMagicProbe(true, deviceSummary, fanSummary, performanceSummary,
